...
Erizo.Bar = function(spec) {
  ...
  that.bar.setAttribute('style',
    'width: 100%; height: 15%; max-height: 30px; position: absolute; bottom: 0; right: 0; background-color: transparent'
  );
...
Erizo.Speaker = function(spec) {
  ...
  that.div = document.createElement('div');
  that.div.setAttribute('style',
    'width: 40%; height: 100%; max-width: 32px; position: absolute; right: 0;z-index:-100;'
  );
  ...
  if (that.stream instanceof Woogeen.RemoteStream) {
    ...
    show = function(displaying) {
      that.picker.setAttribute('style',
        'width: 32px; height: 100px; position: absolute; bottom: 90%; z-index: -100;' +
...
Erizo.VideoPlayer = function(spec) {
  ...
  that.div.setAttribute('id', 'player_' + that.id);
  that.div.setAttribute('style',
    'width: 100%; height: 100%; position: relative; background-color: transparent; overflow: hidden;object-fit: cover;z-index:20000;'
  );
  ...
  that.video.setAttribute('style',
    'width: 100%; height: 100%;object-fit: cover;background-color: transparent;z-index:20000;-webkit-transform: scaleX(-1);');
  that.video.setAttribute('autoplay', 'autoplay');
  that.video.setAttribute('webkit-playsinline', 'playsinline');
  if (spec.stream instanceof Woogeen.LocalStream) {
    that.video.volume = 0;
  }
